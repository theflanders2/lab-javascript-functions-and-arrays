...
function sum(numbers) {
  ...
  for (let i = 0; i < numbers.length; i++) {
    ...
    if (typeof numbers[i] === "number") {
      ...
      throw new Error("unsupported data type (array or object) present in the array");
    }
  }
  sumOfArray = numbersTotal + wordsTotal + boolTotal;
  return sumOfArray;
}
...
function avg(wordsArr) {
  ...
  sumOfArray = numbersTotal + wordsTotal + boolTotal;
  return sumOfArray / wordsArr.length;
}
...
function howManyTimes(wordsCount, wordToFind) {
  ...
  for (i = 0; i < wordsCount.length; i++) { 
    ...
    else if (wordsCount[i] === wordToFind) { 
      timesAppears++;
    }
  }
